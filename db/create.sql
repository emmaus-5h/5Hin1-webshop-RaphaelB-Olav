...
insert into products (name, description, code, price) values ('Platy', 'De Platy is een vis die afkomstig is uit midden Amerika. de vis is gemiddeld 6 cm groot en zwemt graag in warm water. Hij zwemt het liefst in een groep en daarom wordt deze vis per 2 verkocht.', '492662523-7');
