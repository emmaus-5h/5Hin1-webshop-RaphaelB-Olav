...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price,products.school_id AS school, products.zwemgebied_id AS zwemgebied, products.vissengrootte_id AS vissengrootte, FROM products WHERE id = ?')
