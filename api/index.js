...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price,products.school AS school, products.zwemgebied AS zwemgebied, products.vissengrootte aS vissengrootte, FROM products WHERE id = ?')
